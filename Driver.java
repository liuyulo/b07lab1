...
public class Driver{
    public static void main(String[] args) throws IOException{
        ...
        System.out.println(q1.add(q2).add(q1).add(q2));
        q1.add(qq2).add(q1).add(qq2).saveToFile("sum");
        System.out.println(new Polynomial(new File("sum")));

        System.out.println(q1.multiply(q2).multiply(q1).multiply(q2));
        q1.multiply(qq2).multiply(q1).multiply(q2).saveToFile("prod");
        System.out.println(new Polynomial(new File("prod")));
    }
}
